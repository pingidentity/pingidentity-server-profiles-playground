 ...
 * </UL>
 */
public final class VirtualAttributeWeatherInfo
       extends VirtualAttributeProvider
{
   ...
   */
  private static final String ARG_WEATHER_URL_ATTR = "weather-url";
  private static final String ARG_WEATHER_API_KEY_ATTR = "weather-api-key";
  ...
  // attribute.
  private volatile String weatherURL;
  private volatile String weatherAPIKey;
   ...
   */
  public VirtualAttributeWeatherInfo()
  {
  ...
  {
    return "Weather Info Virtual Attribute by ZipCode";
  }
  ...
  public String[] getExtensionDescription()
  {
    return new String[]
    {
      "This is a sample weather info virtual attribute providing json info about " +
              "weather info for a specific zip code."
    };
  }
         ...
         throws ArgumentException
  {
    ...
    String    longIdentifier  = ARG_WEATHER_URL_ATTR;
    boolean   required        = true;
    int       maxOccurrences  = 1;
    String    placeholder     = "{url}";
    String    description     = "The url for the weather api.";

    parser.addArgument(new StringArgument(shortIdentifier, longIdentifier,
         required, maxOccurrences, placeholder, description));

    longIdentifier = ARG_WEATHER_API_KEY_ATTR;
    placeholder = "{api-key}";
         ...
         throws LDAPException
  {
    ...
    // Get the weather attributes.
    StringArgument arg =
         (StringArgument) parser.getNamedArgument(ARG_WEATHER_URL_ATTR);

    weatherURL = arg.getValue();

    arg = (StringArgument) parser.getNamedArgument(ARG_WEATHER_API_KEY_ATTR);

    weatherAPIKey = arg.getValue();
  ...
  {
    String sourceAttribute = "postalCode";
    ...
    String zipCode = attr.getValue();

    String weatherJSON = "*** YOU NEED TO IMPLEMENT getWeather() ***";
    //String weatherJSON = getWeather(zipCode);

    final Attribute va = new Attribute(attributeName, weatherJSON);
    if (serverContext.debugEnabled())
    {
...
//    exampleMap.put(
//         Arrays.asList(ARG_WEATHER_API_KEY_ATTR + "="),
